...
use OnePlace\Translation\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/translation/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/translation/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('translation-api');
    }
}
